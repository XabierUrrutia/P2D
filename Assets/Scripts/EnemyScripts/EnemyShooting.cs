...
public class EnemyShooting : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Lógica Principal de Sprites y Disparo
        if (target != null)
        {
            ...
            {
                // 2. ESTÁ LEJOS: Devolver control al EnemyController (Caminar)
                UnlockAnimation();
            }
        }
        else
    ...
    {
        // Si estamos en medio de la animación de disparo (el retroceso), no hacemos nada visual aquí
    ...
    IEnumerator ShootSequence(Transform target, bool isRight)
    {
        ...
        // 5. Fin de la acción de disparo. 
        // NO desbloqueamos aquí manualmente. El Update lo hará automáticamente:
        // - Si sigue habiendo enemigo cerca -> El Update pondrá sprite de APUNTAR.
        // - Si el enemigo murió o se alejó -> El Update llamará a UnlockAnimation().
    ...
    {
        // Si estamos disparando, no desbloqueamos nada todavía
        if (isShootingAction) return;
